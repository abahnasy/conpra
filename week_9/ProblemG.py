...
# implementation based on https://fishi.devtail.io/weblog/2015/06/25/computing-large-binomial-coefficients-modulo
# -prime-non-prime/ 
...
if __name__ == '__main__':
    ...
    for i in range(int(t)):
        line = input()
        n, k = line.split()
        print("Case #" + str(1+i) + ":", binom(int(n), int(k), mod_facts))
